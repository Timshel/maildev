...
const formats = {
  ...
  mssqltime: {
    regex: RegExp(
      "^" + reHour12 + ":" + reMinutelz + ":" + reSecondlz + "[:.]([0-9]+)" + reMeridian,
      "i",
    ),
    name: "mssqltime",
  ...
  timeLong12: {
    regex: RegExp(
      "^" + reHour12 + "[:.]" + reMinute + "[:.]" + reSecondlz + reSpaceOpt + reMeridian,
      "i",
    ),
    name: "timelong12",
  ...
  xmlRpc: {
    regex: RegExp(
      "^" + reYear4 + reMonthlz + reDaylz + "T" + reHour24 + ":" + reMinutelz + ":" + reSecondlz,
    ),
    name: "xmlrpc",
    callback(match, year, month, day, hour, minute, second) {
      return this.ymd(+year, month - 1, +day) && this.time(+hour, +minute, +second, 0);
  ...
  xmlRpcNoColon: {
    regex: RegExp(
      "^" + reYear4 + reMonthlz + reDaylz + "[Tt]" + reHour24 + reMinutelz + reSecondlz,
    ),
    name: "xmlrpcnocolon",
    callback(match, year, month, day, hour, minute, second) {
      return this.ymd(+year, month - 1, +day) && this.time(+hour, +minute, +second, 0);
  ...
  relativeText: {
    regex: RegExp(
      "^(" + reReltextnumber + "|" + reReltexttext + ")" + reSpace + "(" + reReltextunit + ")",
      "i",
    ),
    name: "relativetext",
  ...
  dateShortWithTimeLong: {
    regex: RegExp(
      "^" + reDateNoYear + "t?" + reHour24 + "[:.]" + reMinute + "[:.]" + reSecond,
      "i",
    ),
  ...
  dateShortWithTimeShort12: {
    regex: RegExp(
      "^" + reDateNoYear + reHour12 + "[:.]" + reMinutelz + reSpaceOpt + reMeridian,
      "i",
    ),
